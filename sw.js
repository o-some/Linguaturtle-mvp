const CACHE='linguaturtle-v11-creative-assets';
const FILES=['./','./index.html','./styles.css','./enhancements.css','./app.js','./enhancements.js','./manifest.webmanifest','./src/data/content.js','./src/core/store.js'];
